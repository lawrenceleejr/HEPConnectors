...
SECTIONS = [
 ('RF & Coaxial — signals, pulses & timing', '50 Ω unless noted', 'cu', [
  ...
  ('sma', 'SMA', '', 'MF',
   'Screw-thread microwave connector to ~18 GHz. Clocks, RF and timing distribution. Plug & jack shown.',
 ...
 ('Network & Pluggable Transceivers — DAQ & slow control', 'copper ↔ optical', 'hy', [
  ...
  ('sfp', 'SFP / SFP+', '', 'MF',
   'Hot-plug transceiver cage — 1 to 10/25 G. Swap between copper, DAC or LC optics. Module & cage shown.',
   '1–25 G · bail', W+'Small_Form-factor_Pluggable', 'SFP+ transceiver', 0),
  ('qsfp', 'QSFP / QSFP-DD', '', 'MF',
   'Quad-lane 40/100/400 G module cage. Spine uplinks and HL-LHC read-out aggregation. Module & cage shown.',
 ...
 ('Data, Serial & Instrumentation Buses', 'the back of every rack', 'cu', [
  ('usb_a', 'USB-A', '', 'MF',
   'The host-side rectangle — one-way only. Peripherals, dongles & front panels. Plug & jack shown.',
  ...
  ('usb_mini', 'USB Mini-B', '', 'MF',
   'Early-2000s portable port — still on older scopes, cameras & dev kits. Plug & jack shown.',
  ...
  ('usbc', 'USB-C', '', 'MF',
   'Reversible power + data up to 240 W / 40 Gb/s — and Thunderbolt in disguise. Plug & jack shown.',
 ...
 ('Audio, Analogue I/O & Power', 'triggers, DMMs & mains', 'cu', [
  ('rca', 'RCA', 'phono', 'MF',
   'Single-ended coax plug — analogue audio/video and the odd lab reference signal. Plug & jack shown.',
   '75 Ω · unbalanced', W+'RCA_connector', 'RCA connector', 0),
  ('jack', 'Phone jack', '3.5 / 6.35 mm', 'MF',
   'TS/TRS/TRRS barrel — audio, and a handy source of trigger & gate pulses. Plug & jack shown.',
